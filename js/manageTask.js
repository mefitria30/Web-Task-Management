...
{
    function capitilizeFirtsChar ( str )
    {
        if ( !str ) return str
        
        return str.charAt(0).toUpperCase() + str.slice(1)
    } // membuat kapital di awal kalimat
    ...
    } // membuat format tanggal panjang
                            ...
                            <div class="task-card flex flex-col gap-5">
                                <div class="flex gap-3 items-center">
                                    ...
                                    <div class="flex flex-col">
                                        <p class="font-bold text-lg leading-[27px]">${capitilizeFirtsChar(task.taskName)}</p>
